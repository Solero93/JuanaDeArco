...
// Fem 4 métodes:
    // 2 de Brayan:
        // un per establir el booleá a true, quan choqui amb l'heroina
        // l'altra per consultar el booleá al final
    // 2 de Escut:
        // un per establir el booleá a true, quan choqui amb l'heroina
        // l'altra per consultar el booleá al final
    
    private boolean brayanTrobat = false;
    
    public void setHaTrobatBrayan(boolean b){
      this.brayanTrobat = b;
    }
    
    public boolean haTrobatBrayan(){
      return brayanTrobat;
    }

    public void setHaTrobatEscut(boolean b){
      this.escutTrobat = b;
    }
